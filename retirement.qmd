...
def growth():
    ...
    growth_df = investpy.growth_simulation(
    ...
    return investpy.growth_plot(growth_df)
``` 
...
@render.plot()
def nav_1():
    nav_df = investpy.withdrawal_simulation(
    ...
    return investpy.withdrawal_plot(
        nav_df,
